        ...
        <nav className="navbar glass-strong">
            <div className="container">
                <div className="nav-content">
                    <a href="#home" className="logo gradient-text" onClick={(e) => { e.preventDefault(); handleNavClick('home') }}>
                        YS
                    </a>
                    ...
                    <div className="social-links">
                        <a href="https://github.com/YugSudani" target="_blank" rel="noopener noreferrer" className="social-icon">
                        ...
                        <a href="https://www.linkedin.com/in/yug-sudani-6a5a58297" target="_blank" rel="noopener noreferrer" className="social-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
